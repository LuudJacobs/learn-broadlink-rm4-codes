"""Interactively learn IR codes button-by-button and save them to ir_codes.json."""

import json
import re
import time

from broadlink_helpers import connect, learn_ir

OUTPUT_FILE = "ir_codes.json"
